            ...
            <div className="discussion-card-four">
              ...
              <div className="discussion-card-four__content">
                ...
                <h3 className="discussion-card-four__title">
                  100 টি মডিউলে 500+ ভিডিও
                </h3>
                <p className="discussion-card-four__text">
                  শিক্ষার্থীরা যেন ধাপে ধাপে শিখতে পারে সেজন্য পুরো কোর্সটি
                  100টি মডিউলে ও 500+ ভিডিওতে ভাগ করে সাজানো হয়েছে।
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6 col-lg-4 mt-4">
            <div className="discussion-card-four">
              ...
              <div className="discussion-card-four__content">
                ...
                <h3 className="discussion-card-four__title">100 টি কুইজ</h3>
                <p className="discussion-card-four__text">
                  শেখার সাথে সাথে শিক্ষার্থীরা যেন নিজেদের প্রোগ্রেস যাচাই করতে
                  পারে সেজন্য প্রতিটি মডিউল শেষে ব্যাখ্যা ও উত্তর সহ কুইজ থাকবে।
                </p>
              </div>
            </div>
          </div>
          <div className="col-md-6 col-lg-4 mt-4">
            <div className="discussion-card-four">
              ...
              <div className="discussion-card-four__content">
                ...
                <p className="discussion-card-four__text">
                  কয়েকটি মডিউল শেষে থাকবে বড় এসাইনমেন্ট যেগুলো আপনারা নিজে
          ...
          <div className="col-md-6 col-lg-4 mt-4">
            <div className="discussion-card-four">
              ...
              <div className="discussion-card-four__content">
                ...
                <h3 className="discussion-card-four__title">24 টি লাইভ সেশন</h3>
                <p className="discussion-card-four__text">
          ...
          <div className="col-md-6 col-lg-4 mt-4">
            <div className="discussion-card-four">
              ...
              <div className="discussion-card-four__content">
                <div className="discussion-card-four__circle"></div>
                <img src="/assets/images/svg/discus4.svg" alt="" />
                <h3 className="discussion-card-four__title">20 টি প্রজেক্ট</h3>
                <p className="discussion-card-four__text">
                  পুরো কোর্সটিতে আমরা প্রজেক্ট ভিত্তিক লার্নিং প্রসেস ফলো করেছি।
                  কোর্সে আমরা মিলেমিশে 20 টি প্রজেক্ট করবো।
                </p>
              </div>
            </div>
          </div>
